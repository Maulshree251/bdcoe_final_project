  ...
  return (
    <div className="explore-menu flex flex-col gap-4 ">
      ...
      <p className="text-[#262626] font-xs font-[600]">
        ...
        <br /> With something for everyone, you’re sure to find a dish that hits
        the spot.
      </p>
      <div className="explore-menu-list flex gap-3 items-center justify-between overflow-x-scroll">
        {menu_list.map((m, index) => (
          <div
            className="menu-list-items flex flex-col justify-center items-center mt-3"
            key={index}
            onClick={() =>
              setCategory((prev) =>
